...
const Passport = ({
  ...
  <div className="w-full max-w-xl bg-yellow-50 p-6 pt-4 text-gray-900 relative">
    ...
    <div className="hidden md:block mb-6 text-blue-900 text-xl text-center font-serif font-bold uppercase">
    ...
    <div className="grid grid-cols-3 gap-8">
      ...
      <dl className="grid gap-2 grid-cols-6 col-span-3 md:col-span-2">
        ...
        <div className="col-span-3 mb-2 md:mb-4">
